...
var rates_ht40 = new Array(13.5, 27, 40.5, 54, 81, 108, 121.5, "135/150", 27, 54, 81, 108, 162, 216, 243, "270/300");
...
function calc_max_txpower()
{
	...
	var max_txpower = 0;
	if (!requiresCE(country) && antenna_gain >= 6)
...
function toggleScanChannels() {
	...
	setDisabled(document.getElementById("scan_channels"), status);
	setDisabled(document.getElementById("edit_scan_channels"), status);
}
