...
<br>
	...
	<tr>
	<td colspan="2" id="refresh" class="change"><input type="button" onClick="return reloadStatus();" value=" <? echo dict_translate("Refresh"); > "></td>
	</tr>
	...
	id="dhcpc_info" class="router bridge"><a href="dhcpc.cgi" target="extraFrame"><? echo dict_translate("DHCP Client"); ></a> | </span><span
	...
	id="sroutes" class="router bridge"><a href="sroutes.cgi" target="extraFrame"><? echo dict_translate("Routes"); ></a> | </span><span
