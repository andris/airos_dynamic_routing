...
Router
iptables FORWARD -i [WAN|LAN|WLAN|PPP] [--protocol [6(TCP)|17(UDP)|1(ICMP)|0(IP)] | -m ipp2p --ipp2p]  --src [!] address[/mask] --dst [!] address[/mask] --sport [!] port1[:port2] --dport [!] port1[:port2] -j [REJECT|DROP|ACCEPT]
*/
...
>		  <tr>
		  ...
		  required="1" callback="validateFirewallIP" realname="<? echo dict_translate("Source IP/Mask"); >"></td><td>&nbsp;</td>
		  ...
		  required="1" callback="validateFirewallIP" realname="<? echo dict_translate("Destination IP/Mask"); >"></td><td>&nbsp;</td>
