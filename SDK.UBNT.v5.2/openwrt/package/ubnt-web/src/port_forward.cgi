...
{
	return validatePFPort(id, name, value, null);
}
...
>
		  ...
		  value="<? echo $dst_ip;>" size="16" maxlength="15"
		  required="1" callback="validatePFIP" realname="<? echo dict_translate("Private IP"); >"></td>
		  <td><input type="text" class="std_width" name="dst_port<? echo $i;>" id="dst_port<? echo $i;>"
		  value="<? echo $dst_port;>" size="6" maxlength="11"
		  required="1" callback="validatePFPort2" realname="<? echo dict_translate("Private Port [1 - 65535]"); >"></td>
		  ...
		  <td><input type="text" class="std_width" name="src_port<? echo $i;>" id="src_port<? echo $i;>"
		  	...
		  	required="1" callback="validatePFPort1" realname="<? echo dict_translate("Public Port (port or portX:portY)"); >" ></td>
