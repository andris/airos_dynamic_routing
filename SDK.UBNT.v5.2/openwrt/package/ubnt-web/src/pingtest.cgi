...
function setupValidation() {
        ...
        if (o) { o.required=1; o.minvalue=1; o.maxvalue=10000;o.realname='<? echo dict_translate("Duration"); >'; }
        o = document.getElementById('ping_size');
        if (o) { o.required=0; o.minvalue=1; o.maxvalue=24800;o.realname='<? echo dict_translate("Data Amount"); >'; }
}
function _runPing(f) {
			...
			<tr>
				<td class="f" colspan="3">
					<? echo sprintf(
						...
						"<span style=\"font-weight: normal;\" id=\"status_rcv\">0</span>",
						"<span style=\"font-weight: normal;\" id=\"status_sent\">0</span>",
						"<span style=\"font-weight: normal;\" id=\"status_loss\">0</span><span style=\"font-weight: normal\">%</span>")>
					
				</td>
			</tr>
			<tr>
			<td class="f"><? echo dict_translate("Min:"); > 
				<span id="status_min">0</span> <strong>ms</strong></td>
			<td class="f"><? echo dict_translate("Avg:"); > 
				<span id="status_avg">0</span> <strong>ms</strong></td>
			<td class="f"><? echo dict_translate("Max:"); > 
				<span id="status_max">0</span> <strong>ms</strong></td>
			</tr>
			</table>
